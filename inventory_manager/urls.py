...
urlpatterns = [
    ...
    path('', authentication_views.LoginView.as_view(template_name='user/login.html'), name='user-login'),
    path('register/', user_view.register, name='user-register'),
    path('logout/', authentication_views.LogoutView.as_view(template_name='user/logout.html'), name='user-logout'),
